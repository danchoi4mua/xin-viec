...
def merge_the_tools(string, k):
    chuoi_sau_khi_chia=textwrap.wrap(string, width=k)

    for tu in chuoi_sau_khi_chia:       
        tu_sau_khi_loc=""
        for chu in tu:            
            if chu in tu_sau_khi_loc:
                pass
            else:
                tu_sau_khi_loc=tu_sau_khi_loc+""+chu
                
        print(tu_sau_khi_loc)
